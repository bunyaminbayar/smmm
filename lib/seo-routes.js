...
export const STATIC_PATHS = [
  ...
  "/iletisim",
  "/hizmetlerimiz",
  "/hizmetlerimiz/muhasebe-mali-isler-yonetimi",
  "/hizmetlerimiz/vergi-danismanligi-beyanname",
  "/hizmetlerimiz/bordrolama-sgk",
  "/hizmetlerimiz/finansal-raporlama",
  "/hizmetlerimiz/ic-kontrol-denetim",
  "/hizmetlerimiz/kdv-iade",
  "/about/about-one",
  "/about/about-two",
  "/blog",
...
export const BLOG_DETAIL_SLUGS = [
  "izmirde-kobiler-icin-vergi-avantajlarina-genel-bakis",
  "e-fatura-ve-e-defter-sureclerinde-dikkat-edilecek-noktalar",
];
