...
export default function page() {
  return (
    <div>      <section className="list-blog three-col lg:mt-[100px] sm:mt-16 mt-10">
              ...
              <div key={b.href} className="blog-item">
                ...
                >
                  ...
                  <div className="infor sm:p-6 p-4">
                    ...
                    {b.excerpt ? (
                      <div className="excerpt body3 text-secondary mt-2" dangerouslySetInnerHTML={{ __html: b.excerpt }} />
                    ) : null}
