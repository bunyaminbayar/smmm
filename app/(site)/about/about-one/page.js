...
export default function Page() {
  return (
    <main className="content fullContainer">
            ...
            <div className="rounded-2xl border border-line bg-white p-7 mt-6">
              ...
              <div className="grid gap-4 sm:grid-cols-2 mt-4">
                {[
                  ...
                  <div key={v.title} className="rounded-2xl bg-surface p-4">
      ...
      <div className="container py-24 md:py-32 pt-8">
        ...
        <div className="mt-8 flex items-center gap-4 flex-wrap">
          ...
          <Link className="button-main bg-white text-on-surface rounded-full border border-line" href="/iletisim">
            İletişime geçin
          </Link>
        </div>
      </div>
